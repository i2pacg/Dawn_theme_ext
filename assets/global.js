...
class QuantityInput extends HTMLElement {
   ...
   */
      ...
      if (price__regular.querySelector(".money.buckscc-converted.buckscc-money")) {
        ...
        price__regular__converted.setAttribute('bucks-current', `${currencyFormats[moneyFormat].replace('{{amount}}', converted)}`);
        price__regular__converted.textContent = `${currencyFormats[moneyFormat].replace('{{amount}}', converted)}`;
      } else {
      ...
      if (price__sale.querySelector(".money.buckscc-converted.buckscc-money")) {
        ...
        price__sale__converted.setAttribute('bucks-current', `${currencyFormats[moneyFormat].replace('{{amount}}', converted)}`);
        price__sale__converted.textContent = `${currencyFormats[moneyFormat].replace('{{amount}}', converted)}`;
      } else {
      ...
      if (price__last.querySelector(".money.buckscc-converted.buckscc-money")) {
        ...
        price__last__converted.setAttribute('bucks-current', `${currencyFormats[moneyFormat].replace('{{amount}}', converted)}`);
        price__last__converted.textContent = `${currencyFormats[moneyFormat].replace('{{amount}}', converted)}`;
      } else {
...
class VariantSelects extends HTMLElement {
  ...
  onVariantChange() {
    ...
    if (!this.currentVariant) {
      ...
      document
        .querySelector(".upload-size")
        .toggleAttribute("display", this.options.includes("Custom"));
    }
  }
...
class VariantRadios extends VariantSelects {
  ...
  updateOptions() {
    const fieldsets = Array.from(
      this.querySelectorAll("fieldset:not(.filepond--data)")
    );
